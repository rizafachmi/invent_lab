...
--
-- Host: localhost
-- Generation Time: Feb 11, 2022 at 07:06 AM
...
INSERT INTO `t_alat` (`id_alat`, `id_lab`, `nama_alat`, `status_alat`, `jumlah_alat`, `keterangan`) VALUES
...
INSERT INTO `t_alat_digital` (`id_alat`, `id_lab`, `nama_alat`, `status_alat`, `jumlah_alat`, `keterangan`) VALUES
(1, 7, 'IC 7462', 'Bagus', 4, 'Rak 1'),
(2, 7, 'Commisioning Robot', 'Bagus', 2, 'Rak 1');
...
INSERT INTO `t_alat_iml` (`id_alat`, `id_lab`, `nama_alat`, `status_alat`, `jumlah_alat`, `keterangan`) VALUES
(1, 2, 'Meja Praktikum IML 1', 'Bagus', 1, 'di Lab. IML'),
(2, 2, 'Meja Praktikum IML 2', 'Bagus', 1, 'di Lab. IML'),
(3, 2, 'Meja Praktikum IML 3', 'Bagus', 1, 'di Lab. IML'),
(4, 2, 'Meja Praktikum IML 4', 'Bagus', 1, 'di Lab. IML'),
(5, 2, 'Meja Praktikum IML 5', 'Bagus', 1, 'di Lab. IML'),
(6, 2, 'Meja Praktikum IML 6', 'Bagus', 1, 'di Lab. IML'),
(7, 2, 'Meja Praktikum IML 7', 'Bagus', 1, 'di Lab. IML'),
(8, 2, 'Meja Praktikum IML 8', 'Bagus', 1, 'di Lab. IML'),
(9, 2, 'Meja Praktikum IML 9', 'Bagus', 1, 'di Lab. IML'),
(10, 2, 'Meja Praktikum IML 10', 'Bagus', 1, 'di Lab. IML'),
(11, 2, 'Meja Praktikum IML 11', 'Bagus', 1, 'di Lab. IML'),
(12, 2, 'Meja Praktikum IML 12', 'Bagus', 1, 'di Lab. IML'),
(13, 2, 'MCB 3 Phase C10', 'Bagus', 11, 'Panel 1'),
(14, 2, 'MCB 3 Phase 6A', 'Bagus', 11, 'Panel 1'),
(15, 2, 'MCB 1 Phase 4A', 'Bagus', 11, 'Panel 1'),
(16, 2, 'MCB 1 Phase 2A', 'Bagus', 11, 'Panel 1'),
(17, 2, 'LED 220 VAC 10 PL - 101', 'Bagus', 18, 'Panel 1'),
(18, 2, 'PB Emg Hanyoung 1112', 'Bagus', 6, 'Panel 2'),
(19, 2, 'Fitting Lampu Broco', 'Bagus', 18, 'Panel 2'),
(20, 2, 'Socket Timer/Relay', 'Bagus', 18, 'Panel 2'),
(21, 2, 'Saklar CAM I-O-II Matrix', 'Bagus', 6, 'Panel 3'),
(22, 2, 'Saklar SPST Broco', 'Bagus', 6, 'Panel 3'),
(23, 2, 'Saklar SPDT TUV', 'Bagus', 12, 'Panel 3'),
(24, 2, 'Saklar DPDT Philips', 'Bagus', 6, 'Panel 3'),
(25, 2, 'Saklar CAM Y - Delta', 'Bagus', 6, 'Panel 4'),
(26, 2, 'Limit Switch Omron', 'Bagus', 6, 'Panel 4'),
(27, 2, 'Rotary CAM Nux', 'Bagus', 6, 'Panel 4'),
(28, 2, 'Kontaktor Mitshubushi S-T25', 'Bagus', 18, 'Panel 5'),
(29, 2, 'Dioda IR 40HF 120', 'Bagus', 12, 'Panel 5'),
(30, 2, 'ORL Fuji Electric', 'Bagus', 6, 'Panel 6'),
(31, 2, 'Lampu Merah Shemsco', 'Bagus', 12, 'Panel 7'),
(32, 2, 'Lampu Hijau Shemsco', 'Bagus', 12, 'Panel 7'),
(33, 2, 'PB Merah Hanyoung 1306', 'Bagus', 12, 'Panel 7'),
(34, 2, 'PB Hijau Hanyoung 1306', 'Bagus', 12, 'Panel 7'),
(35, 2, 'Zelio SR2 - B201BD', 'Bagus', 2, 'Panel 8'),
(36, 2, 'Motor Listrik 3 Phase 2 Kecepatan', 'Bagus', 4, 'Lemari Motor'),
(37, 2, 'Motor Listrik 1 Phase ', 'Bagus', 2, 'Lemari Motor');
...
INSERT INTO `t_alat_plc` (`id_alat`, `id_lab`, `nama_alat`, `status_alat`, `jumlah_alat`, `keterangan`) VALUES
(1, 8, 'PLC Omron', 'Bagus', 3, 'Lemari 2');
...
INSERT INTO `t_alat_pnh` (`id_alat`, `id_lab`, `nama_alat`, `status_alat`, `jumlah_alat`, `keterangan`) VALUES
(1, 9, 'Solenoid Valve 5/2', 'Bagus', 1, 'Rak 1');
