<?php
    include "../config.php";
    $query = mysqli_query($koneksi,"SELECT * FROM t_alat_are");
    $query_lab = mysqli_query($koneksi,"SELECT * FROM t_laboratorium where id_lab=6"); 
    ...
    <body id="page-top">
        <div id="wrapper">
            <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
                ...
                <div class="sidebar-brand-text mx-3">Inventaris Lab. ARE</div>
                </a>
                ...
                <li class="nav-item active">
                    ...
                    <div id="collapsePages" class="collapse show" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            <a class="collapse-item" href="index.php">Data Barang</a>
                        </div>
                    </div>
                    <div id="collapsePages" class="collapse show" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">Laboratorium Analisis Rangkaian Elektrik</h6>
                            </div>
                        </div>

                        <!-- form tambah data barang-->
                        <form class="form-horizontal" action="log_tambah.php" method="post" enctype="multipart/form-data">
                            <div class="form-group">
                                <label class="control-label col-sm-2" for="id_alat">No Alat:</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="id_alat" id="id_alat" placeholder="No. Alat" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="number" class="form-control" value="<?=$data_lab['id_lab'];?>" name="id_lab" id="id_lab" placeholder="<?=$data_lab['id_lab'];?>" readonly>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="number" class="form-control" name="jumlah_alat" id="jumlah_alat" placeholder="Jumlah Alat" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="col-sm-offset-10 col-lg-10">
                                    <button type="submit" class="btn btn-primary float-right" name="insert">Tambah</button>
                                </div>
                            </div>
                        </form>
                        <!-- +++++++++++++++++++++++-->
