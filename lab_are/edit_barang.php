<?php
    ...
    $query = mysqli_query($koneksi,"SELECT * FROM t_alat_are WHERE id_alat = '$id_alat'");
...
<html lang="en">
    <head>
        ...
        <title>Lab. Analisis Rangkaian Elektrik</title>
    ...
    <body id="page-top">
        <div id="wrapper">
            <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
                <a class="sidebar-brand d-flex align-items-center justify-content-center" href="lab_iml.php">
