<?php
    include "../config.php";
    $query = mysqli_query($koneksi,"SELECT * FROM t_alat_plc");
    $query_lab = mysqli_query($koneksi,"SELECT * FROM t_laboratorium where id_lab=8"); 
    ...
    <body id="page-top">
        <div id="wrapper">
            <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
                ...
                <div class="sidebar-brand-text mx-3">Inventaris Lab. PLC</div>
                </a>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">Laboratorium PLC</h6>
                            </div>
                        </div>
