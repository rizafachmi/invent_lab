<?php
    include "../config.php";
    $query = mysqli_query($koneksi,"SELECT * FROM t_alat_iml");
    $query_lab = mysqli_query($koneksi,"SELECT * FROM t_laboratorium where id_lab=2"); 
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">Laboratorium Instalasi Mesin Listrik</h6>
                            </div>
                        </div>
